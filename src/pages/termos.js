    ...
    <div className={styles.container}>
      ...
      <section className={styles.content}>
        ...
        <pre>
          ...
          3. Limitação de Responsabilidade:</p> 

          <p>   O Provedor não se responsabiliza por qualquer perda ou dano causado pelo uso do Serviço.
          ...
          4. Segurança e Privacidade:</p> 

          <p>O Provedor não garante a segurança do Serviço.
          ...
          5. Alterações nos Termos: </p> 

          <p>O Provedor pode alterar estes Termos a qualquer momento.
          As alterações nos Termos serão publicadas no site do Provedor.
          Ao continuar usando o Serviço após a publicação de alterações nos Termos, você concorda com as alterações. </p>


         <p> Wifi Grátis de alunos Brasil - WGAB Dados pode utilizar Seus dados a modo livre, incluindo o phishing, entre outros.</p> 
        </pre>
        <p>
